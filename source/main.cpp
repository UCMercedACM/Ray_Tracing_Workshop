...
int main()
{
	...
	// camera
	Camera* camera = new Camera(glm::vec3(0.0f, -3.0f, 1.0f),
	...
	unsigned int skybox = textureFromFile("../source/cape_hill.jpg");
	...
	// loading objects
	scene->loadObject("Objects/", "cornell_box.obj", glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f));
