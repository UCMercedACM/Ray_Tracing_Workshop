...
public:
	...
	{
		albedo_shader = new Shader("../source/Shaders/Vertex.shader", "../source/Shaders/AlbedoFragment.shader");
		normal_shader = new Shader("../source/Shaders/Vertex.shader", "../source/Shaders/NormalFragment.shader");
		fresnel_shader = new Shader("../source/Shaders/Vertex.shader", "../source/Shaders/FresnelFragment.shader");
		bvh_shader = new Shader("../source/Shaders/Vertex.shader", "../source/Shaders/BVHFragment.shader");
		path_shader = new Shader("../source/Shaders/Vertex.shader", "../source/Shaders/PathTraceFragment.shader");

		curr_shader = path_shader;

		accumulate_shader = new Shader("../source/Shaders/Vertex.shader", "../source/Shaders/AccumulateFragment.shader");
		post_process_shader = new Shader("../source/Shaders/Vertex.shader", "../source/Shaders/PostProcessFragment.shader");
	...
	void render(Scene* scene)
	{
		...
		curr_shader->setInt("skybox_texture", 0);
		...
		// scene->num_nodes
		int num_nodes = scene->nodes.size();
		glBufferSubData(GL_UNIFORM_BUFFER, 76, 4, &num_nodes);
		// current frame
